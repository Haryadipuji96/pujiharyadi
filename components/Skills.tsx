...
const skillCategories = [
  {
    ...
    skills: [
      { name: 'React.js / Next.js', level: 50, color: 'from-blue-500 to-cyan-400' },
      { name: 'Tailwind CSS', level: 70, color: 'from-teal-500 to-emerald-400' },
      { name: 'JavaScript (ES6+)', level: 45, color: 'from-yellow-500 to-orange-400' },
      { name: 'HTML5 / CSS3', level: 85, color: 'from-orange-500 to-red-400' },
    ],
  },
  {
    ...
    skills: [
      { name: 'Laravel 11', level: 85, color: 'from-red-500 to-pink-400' },
      { name: 'Node.js / Express', level: 40, color: 'from-green-500 to-emerald-400' },
      { name: 'Python / Django', level: 30, color: 'from-blue-700 to-blue-500' },
      { name: 'RESTful APIs', level: 50, color: 'from-purple-500 to-pink-400' },
    ],
  },
  {
    ...
    skills: [
      { name: 'MongoDB', level: 60, color: 'from-green-600 to-green-400' },
      { name: 'PostgreSQL', level: 50, color: 'from-blue-800 to-blue-600' },
      { name: 'phpMyAdmin', level: 100, color: 'from-orange-600 to-amber-500' },
      { name: 'Git / GitHub', level: 94, color: 'from-gray-700 to-gray-500' },
      { name: 'Docker', level: 40, color: 'from-blue-400 to-cyan-300' },
    ],
  },
  {
    ...
    skills: [
      { name: 'Android Studio', level: 65, color: 'from-green-700 to-emerald-500' },
      { name: 'Kotlin / Java', level: 35, color: 'from-orange-700 to-orange-500' },
      { name: 'Flutter', level: 70, color: 'from-blue-400 to-cyan-300' },
      { name: 'Desktop Apps', level: 50, color: 'from-gray-600 to-gray-400' },
    ],
  },
  {
    ...
    skills: [
      { name: 'Problem Solving', level: 87, color: 'from-purple-600 to-purple-400' },
      { name: 'Team Collaboration', level: 95, color: 'from-indigo-500 to-blue-400' },
      { name: 'Microsoft Office', level: 88, color: 'from-red-600 to-orange-500' },
      { name: 'Communication', level: 90, color: 'from-cyan-500 to-blue-400' },
  ...
  },
  {
    ...
    skills: [
      { name: 'AWS / Vercel', level: 95, color: 'from-orange-600 to-yellow-500' },
      { name: 'Linux Server', level: 20, color: 'from-yellow-600 to-yellow-400' },
      { name: 'Nginx / Apache', level: 65, color: 'from-green-700 to-green-500' },
      { name: 'Monitoring Tools', level: 50, color: 'from-red-500 to-pink-400' },
    ],
  },
]
