  ...
  return (
    <section id="experience" className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute bottom-20 left-10 w-64 h-64 bg-gradient-to-tr from-cyan-100 to-blue-100 rounded-full blur-3xl opacity-30"></div>
      </div>
        ...
        {viewMode === 'timeline' ? (
          <>
            ...
            <div className="relative">
              ...
              <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-blue-500 via-cyan-400 to-blue-300"></div>
              ...
              <div className="space-y-8 md:space-y-12">
                {experiences.map((exp, index) => (
                  ...
                  >
                    {/* Timeline Dot */}
                    <div className="absolute left-6 md:left-1/2 md:-translate-x-1/2 w-4 h-4 bg-gradient-to-br from-blue-600 to-cyan-500 rounded-full border-4 border-white shadow-lg z-10"></div>
                    ...
                    >
                      ...
                      >
                        ...
                        {/* Description */}
                        <p className="text-gray-600 text-sm md:text-base mb-4">{exp.description}</p>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-xl border border-gray-200">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-800">Perkembangan Skill Saya</h3>
                <p className="text-gray-600">Kemajuan dan penguasaan teknologi yang terus berkembang</p>
              </div>
            </div>
            ...
            <div className="mt-10 pt-8 border-t border-gray-200">
              <h4 className="text-xl font-bold text-gray-800 mb-6">Perjalanan Belajar</h4>
