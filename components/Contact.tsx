    ...
    <section id="contact" className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div>
            <div className="mb-8">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Mari Berkolaborasi</h3>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-6 mb-8">
              <h4 className="text-lg font-bold text-gray-800 mb-4">Pertanyaan Cepat</h4>
            ...
            {/* Social Links */}
<div>
  <h4 className="text-lg font-bold text-gray-800 mb-4">Temui Saya di Media Sosial</h4>
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-2xl border border-gray-200">
                ...
                <div>
                  ...
                  <div className="pt-6 border-t border-gray-200">
                    <p className="text-sm text-gray-600 text-center">
                      ...
                      <a href="#" className="text-blue-600 hover:underline">kebijakan privasi</a> saya.
                      <br />
              ...
              <div className="mt-6 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-5">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800">Jaminan Respon Cepat</h4>
