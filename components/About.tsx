  ...
  return (
    <section id="about" className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute bottom-20 right-10 w-72 h-72 bg-cyan-100 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse delay-1000"></div>
      </div>
          ...
          <div className="grid lg:grid-cols-12 gap-0">
            ...
            <div className="lg:col-span-7 p-8 lg:p-12">
              ...
              <div className="mb-10">
                ...
                {activeTab === 'skills' && (
                  <div>
                    <h4 className="text-2xl font-bold text-gray-900 mb-6">Keahlian Saya</h4>
                ...
                {activeTab === 'info' && (
                  <div>
                    <h4 className="text-2xl font-bold text-gray-900 mb-6">Lebih Lanjut Tentang Saya</h4>
                    ...
                    <div className="mt-6 bg-gradient-to-r from-blue-600/10 to-cyan-500/10 rounded-2xl p-6">
                      <h5 className="font-semibold text-gray-900 mb-3">Ketersediaan CV</h5>
